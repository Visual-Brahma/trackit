...
const GroupsPage=async () => {
    ...
    const groups=await dbClient.selectFrom("Group")
        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-2">
                <TypographyP className="my-4 max-w-xl">
                    ...
                    You can chat, schedule meetings, get better overview of attendance of members over time and more.
                </TypographyP>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-2">
                {
                    groups.map((group) => (
                        <Card className="w-[354px] my-5 rounded-2xl">
                            <CardHeader>
                                <CardTitle className='text-white text-left'>{group.name}</CardTitle>
                            </CardHeader>
