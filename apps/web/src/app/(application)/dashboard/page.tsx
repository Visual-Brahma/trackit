    ...
    const features: FeatureCardProps[]=[
        {
            ...
            description: "Keep track of your attendance and generate reports for your meetings and classes.",
        ...
        {
            title: "Notes",
            description: "Take notes in your meetings or later and keep track of your progress.",
