    ...
    <div className="flex flex-col items-center justify-center gap-4 p-2 min-h-screen">
      {localStorageReportsCount > 0 ? (
        <>
          ...
          <TypographyP>
            Please don't close or refresh this tab. It will just take a few
            seconds.
          </TypographyP>
          <TypographyP>
            Reports in localStorage: {localStorageReportsCount}{" "}
          </TypographyP>
          <LoadingCircle />
        </>
      ) : (
        <>
          ...
          <TypographyP>
            There are no reports in your browser localstorage to update.
          </TypographyP>
          <TypographyP>
            Refresh this page if you think there should be an attendance report.
          </TypographyP>
