        ...
        <div className="flex mx-5 h-screen max-w-screen-xl items-center justify-between xl:mx-auto">
            <div className="mt-4">
                ...
                <p className={'text-lg sm:text-xl md:text-2xl text-muted-foreground mb-12 text-left'}>
                    You can reach out to us anytime at <a href="mailto:teamtrackit@gmail.com" className={"text-primary underline-offset-4 hover:underline"}>teamtrackit@gmail.com</a>.
                </p>
