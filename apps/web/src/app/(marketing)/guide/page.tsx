    ...
    <div className="flex-col mx-5 min-h-screen mt-5 sm:mt-0 max-w-screen-xl items-center justify-between xl:mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-2xl p-12 w-full py-16 mt-16">
        ...
        <div className="mt-4">
          ...
          >
            1. Add Trackit extension to your favourite browser from Trackit
            website homepage.
            <br />
            2. Sign up on trackit website.
            <br />
            3. Enjoy your meet without taking tension of attendance.
            <br />
            4. As your meet ends we will show you the attendance report
            automatically.
            <br />
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-2xl p-12 w-full py-16">
        <div className="text-left">
          ...
          <TypographyP>
            In this video I have discussed how the extension works and how to
