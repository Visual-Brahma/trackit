  ...
  const downloadPdf = () => {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ["Start Time", formatTime(reportInfo.startTimestamp.toISOString().split("T")[1]!.split(".")[0]!)],
        ["End Time", formatTime(reportInfo.endTimestamp.toISOString().split("T")[1]!.split(".")[0]!)],
