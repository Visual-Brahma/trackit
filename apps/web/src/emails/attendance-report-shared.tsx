...
export const AttendanceReportSharedEmail=({ name, url }: AttendanceReportShareEmailProps) => {
    ...
    return (
        <EmailLayout previewText={previewText}>
            ...
            <Text className="text-muted">
                You're receiving this email because someone has shared an attendance report with you on <Link href={environmentVariables.baseUrl}>Trackit</Link>.
