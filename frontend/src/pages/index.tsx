  ...
  return (
    <Layout>
      <div className={'flex flex-col items-center justify-center h-screen'}>
        ...
        <p
          className={
            'text-lg sm:text-xl md:text-2xl text-gray-500 dark:text-gray-400 text-center mb-12 max-w-screen-sm'
          }
        >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 text-2xl p-8'>
          ...
          >
            ...
            <option
              ...
              value='https://microsoftedge.microsoft.com/addons/detail/trackit-meet-attendance/chidnckliojipjihhfmjdmehaglhplcl'
            >
              Microsoft Edge
            </option>
            <option
              className='text-black'
              value='https://chrome.google.com/webstore/detail/trackit-meet-attendance-c/aopejafeamijmefcoclhohoaggbfhcgh/related?utm_source=googleads&utm_medium=adgroup5&utm_campaign=adgroup5&utm_id=adgroup5&gclid=CjwKCAiAprGRBhBgEiwANJEY7D9D94sOFqe-yMI3iC5c-1iZOiMusn6quP52k1Epv8puiQyZ8BxEWxoCk9EQAvD_BwE'
            >
              Google Chrome
            </option>
            <option
              className='text-black'
              value='https://addons.mozilla.org/en-US/firefox/addon/trackit'
            >
              Mozilla Firefox
            </option>
            <option
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-8 sm:p-24 bg-gray-200 dark:bg-light-gray'>
        <div className='rounded-lg bg-gray-200 border-gray-400 border-2 dark:bg-dark-gray drop-shadow-2xl hover:drop-shadow-lg'>
          <div className='p-8'>
            ...
            <p className='text-lg sm:text-xl md:text-2xl text-gray-500 dark:text-gray-400 mb-12 text-left max-w-screen-md dark:text-white-200'>
              Everything is done for you automatically. Just download trackit
              extension and relax.
            </p>
          </div>
        </div>
        ...
        <div className='rounded-lg bg-gray-200 border-gray-400 border-2 dark:bg-dark-gray drop-shadow-2xl hover:drop-shadow-lg'>
          <div className='p-8'>
            ...
            <p className='text-lg sm:text-xl md:text-2xl text-gray-500 dark:text-gray-400 mb-12 text-left max-w-screen-md dark:text-white-200'>
              Trackit is built to provide simplicity to users.
            </p>
          </div>
        </div>
        <div className='rounded-lg bg-gray-200 border-gray-400 border-2 dark:bg-dark-gray drop-shadow-2xl hover:drop-shadow-lg'>
        ...
        <div className='rounded-lg bg-gray-200 border-gray-400 border-2 dark:bg-dark-gray drop-shadow-2xl hover:drop-shadow-lg'>
          <div className='p-8'>
            ...
            <p className='text-lg sm:text-xl md:text-2xl text-gray-500 dark:text-gray-400 mb-12 text-left max-w-screen-md dark:text-white-200'>
              All your attendance reports are securely stored in our database.
      ...
      <div>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 text-2xl p-12 py-16 w-full'>
          <div className='mt-4'>
            <h1
              className={
                'text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-black dark:text-white text-left mb-8 max-w-screen-md'
              }
            >
              Fully Automatic
            </h1>
        ...
        <div className='bg-gray-200 dark:bg-light-gray grid grid-cols-1 md:grid-cols-2 gap-8 text-2xl p-12 w-full py-16'>
          ...
          <div className='mt-4'>
            ...
            <p
              className={
                'text-lg sm:text-xl md:text-2xl text-gray-500 dark:text-gray-400 mb-12 text-left max-w-screen-md dark:text-white-200'
              }
            >
