...
const Layout: FC<CustomComponentProps>=({ children }) => {
    ...
    return (
        <div className="dark:bg-black">
            <Head>
                <title>Trackit</title>
                <meta name="description" content="Introducing TrackIt - the ultimate Google Meet attendance tracker extension! Trackit takes the hassle out of tracking attendance by providing detailed reports on who attended your meetings and how much. With easy installation and seamless integration with Google Meet, TrackIt allows you to start tracking attendance immediately. Say goodbye to manual attendance taking and hello to effortless reporting with TrackIt. Try it now and streamline your virtual meetings!" />
            </Head>
            <div className={`fixed top-0 w-full ${isScrolled? 'border-b border-black-100 bg-white/50 backdrop-blur-xl dark:bg-black/50':'bg-white/0'} z-30 transition-all`}>
